...
(function(factory) {
    ...
    TableClass.option2 = {
        version: "1.4",
        page: {
            align: 'center', //对齐方式，可选left|right | center，默认left
            groups: 5, //显示连续页码数量
            limit: 10, //每页显示的条数
            curr: 1, //当前页
            count: -1 //总条数
    ...
    TableClass.utils = {
        ...
        //     var elem = $div[0];
        //     console.log(elem.offsetHeigh, '我是新高度')
        //     console.log(elem, '我是元素')
        ...
        init: function() {
            ...
            var addExpand = false,
                cols = tableCache.cols[that.tableIndex] = [];
            options.colsCount = 0;
            ...
            $tbhead.find("tr").each(function() {
                ...
                $(this).find("th").each(function() {
                    ...
                    if (fixed === 'left') {
                        ...
                        if (!isInsertL) {
                            isInsertL = true;
                            htmlL.push('<tr style="height:' + $trobj.height() + 'px">');
                        }
                        objClone = $(this).clone();
                        ...
                        if (!isInsertR) {
                            isInsertR = true;
                            htmlR.push('<tr style="height:' + $trobj.height() + 'px">');
                        }
                        objClone = $(this).clone();
        ...
        modifyFixedHeight: function(isneedAmendHead) {
            ...
            if (isneedAmendHead || options.autoColNums > 0) {
                ...
                var trc = head_fixed_l.find("tr").length,
                    tmp, index;
                if (trc > 0) {
                    tmp = trheadCount - 1;
                    index = trc - 1;
            ...
            $obj.on("click.raytableChk", "input.rayui-chk", function() {
                ...
                if (options.singleSelect) {
                    ...
                    if ($chked.length > 0 && typeof options.onCheck === "function") {
                        var $trpre = $chked.closest("tr"),
                            indexpre = $trpre.index();
